                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                                    ...
                                    <div className="mt-1 h-2 bg-gray-200 rounded-full">
                                        <div 
                                            className={`h-2 rounded-full transition-all duration-300 ${
                                                ...
                                                strengthInfo.score === 3 ? 'bg-green-500' : 'bg-gray-300'
                                            }`}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`appearance-none rounded-lg relative block w-full px-4 py-3 pr-10 border placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-200 ${
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        ...
                        <ul className="text-xs text-gray-600 space-y-1">
                            ...
                            <li className={`flex items-center ${passwordsMatch && password && confirmPassword ? 'text-green-600' : ''}`}>
                                <span className="mr-2">{passwordsMatch && password && confirmPassword ? '✓' : '•'}</span>
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={loading || !userId || !secret || !passwordsMatch || password.length < 6}
